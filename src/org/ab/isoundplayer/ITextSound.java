...
public class ITextSound extends PApplet
{
    private static final Logger log = Logger.getLogger(ITextSound.class
            .getName());
    ...
    public static void main(String args[])
    {
        ...
        { location, "--hide-stop", display, "words.WordDisplayer" });
